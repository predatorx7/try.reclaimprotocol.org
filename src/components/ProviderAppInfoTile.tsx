...
export const ProviderAppInfoTile = ({ applicationId, providerId }: { applicationId: string; providerId: string }) => {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {isLoadingProvider || !providerInfo?.logoUrl ? (
                    ...
                    <img
                        ...
                        onError={(e) => {
                            console.error('Failed to load provider logo:', providerInfo.logoUrl);
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#454242ff">
            ...
            <div style={{
                ...
                {isLoadingApplication || !applicationInfo?.appImageUrl ? (
                    ...
                    <img
                        ...
                        onError={(e) => {
                            console.error('Failed to load application image:', applicationInfo.appImageUrl);
                            // Optionally set a fallback image
                            const target = e.currentTarget as HTMLImageElement;
                            target.style.display = 'none';
                        }}
